...
const glm::vec3 _DEFAULT_CAMERA_POS    = glm::vec3(0.0f, 0.0f, 3.0f);
const glm::vec3 _DEFAULT_CAMERA_UP     = glm::vec3(0.0f, 1.0f, 0.0f);
const glm::vec3 _DEFAULT_CAMERA_FRONT  = glm::vec3(0.0f, 0.0f, -1.0f);
const glm::vec3 _DEFAULT_CAMERA_TARGET = glm::vec3(0.0f, 0.0f, 0.0f);
const float     _DEFAULT_FOV           = 45.0f;
const float     _DEFAULT_NEAR_DIS      = 0.1f;
const float     _DEFAULT_FAR_DIS       = 100.f;
const float     _DEFAULT_CAMERA_DIS    = 3.0f;
...
private:
    ...
    glm::vec3 m_cameraPos   = _DEFAULT_CAMERA_POS;
    glm::vec3 m_up          = _DEFAULT_CAMERA_UP;
    glm::vec3 m_front       = _DEFAULT_CAMERA_FRONT;
    glm::vec3 m_target      = _DEFAULT_CAMERA_TARGET;

    float m_yaw             = 0.0f;
    float m_pitch           = 0.0f;
    bool m_ViwMatChanged  = true;

    float m_fov             = _DEFAULT_FOV;
    float m_nearDistance    = _DEFAULT_NEAR_DIS;
    float m_farDistance     = _DEFAULT_FAR_DIS;
    float m_cameraDistance  = _DEFAULT_CAMERA_DIS;
